    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(related_name='pa_spider', on_delete=django.db.models.deletion.SET_NULL, verbose_name=b'\xe4\xb8\xaa\xe4\xba\xba\xe7\x88\xac\xe8\x99\xab', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
            },
            bases=(models.Model,),
